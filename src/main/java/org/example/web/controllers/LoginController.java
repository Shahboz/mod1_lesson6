...
public class LoginController {
    ...
    public String register(@Valid LoginForm user, BindingResult bindingResult, Model model) {
        if(!bindingResult.hasErrors() && loginService.addUser(user)) {
            logger.info("New user \"" + user + "\" register");
